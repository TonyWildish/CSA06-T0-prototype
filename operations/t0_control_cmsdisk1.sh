...
# Local run directory
#
export T0_LOCAL_RUN_DIR="/data1a/tier0"
...
start(){
    ...
    mkdir -p ${T0_LOCAL_RUN_DIR}/workdir
    cd ${T0_LOCAL_RUN_DIR}/workdir

    prog="CopyManager/CopyWorker"
    echo -n $"Starting $prog"

    nohup ${T0ROOT}/src/${prog}.pl --config $T0_CONFIG >> ${T0_LOCAL_RUN_DIR}/Logs//${prog}_1.log 2>&1 &
    sleep 3
    echo

    nohup ${T0ROOT}/src/${prog}.pl --config $T0_CONFIG >> ${T0_LOCAL_RUN_DIR}/Logs/${prog}_2.log 2>&1 &
    sleep 3
    echo

#    nohup ${T0ROOT}/src/${prog}.pl --config $T0_CONFIG >> ${T0_LOCAL_RUN_DIR}/Logs/${prog}_3.log 2>&1 &
#    sleep 3
#    echo

#    nohup ${T0ROOT}/src/${prog}.pl --config $T0_CONFIG >> ${T0_LOCAL_RUN_DIR}/Logs/${prog}_4.log 2>&1 &
#    sleep 3
#    echo

#    nohup ${T0ROOT}/src/${prog}.pl --config $T0_CONFIG >> ${T0_LOCAL_RUN_DIR}/Logs/${prog}_5.log 2>&1 &
#    sleep 3
#    echo
