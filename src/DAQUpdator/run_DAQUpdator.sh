...
export ORACLE_HOME="/afs/cern.ch/project/oracle/@sys/10103"
export TNS_ADMIN="/afs/cern.ch/project/oracle/admin"
export LD_LIBRARY_PATH="/afs/cern.ch/project/oracle/@sys/10103/lib"

#
# Run perl script
#

perl -w /afs/cern.ch/user/p/pgoglov/public/T0_DEV/CMSSW_1_2_0/src/COMP/T0/src/DAQUpdator/DAQUpdator.pl $@
